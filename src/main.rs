...
#[derive(Parser)]
#[clap(name = "DLsiteRenamer", version = "0.3", author = "Jade")]
#[clap(about = "本程序将自动读取你的预设目录，并重命名其中DLsite番号文件和文件夹为实际作品标题，部分作品使用了非法的标点符号或者长度超出系统限制会重命名失败，请手动重命名", long_about = None)]
struct Cli {
